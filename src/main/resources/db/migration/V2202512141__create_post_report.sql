...
CREATE TABLE post_report (
                             ...
                             CONSTRAINT fk_post_report_reporter FOREIGN KEY (reporter_id) REFERENCES users (user_id),
                             CONSTRAINT fk_post_report_reported_user FOREIGN KEY (reported_user_id) REFERENCES users (user_id)
);

...
public enum ImageErrorCode implements AppError {
    ...
    POST_IMAGES_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "이미 게시글 이미지가 존재합니다."),
    USER_IMAGES_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "이미 유저 이미지가 존재합니다."),
    CHATROOM_IMAGES_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "이미 채팅방 이미지가 존재합니다.");
